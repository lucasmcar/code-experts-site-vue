...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, getRequestWebStream, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, readBody, getResponseStatusText } from 'file:///var/www/html/code-experts-site-vue/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///var/www/html/code-experts-site-vue/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///var/www/html/code-experts-site-vue/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///var/www/html/code-experts-site-vue/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///var/www/html/code-experts-site-vue/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///var/www/html/code-experts-site-vue/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///var/www/html/code-experts-site-vue/node_modules/nitropack/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///var/www/html/code-experts-site-vue/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///var/www/html/code-experts-site-vue/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///var/www/html/code-experts-site-vue/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///var/www/html/code-experts-site-vue/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///var/www/html/code-experts-site-vue/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///var/www/html/code-experts-site-vue/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///var/www/html/code-experts-site-vue/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///var/www/html/code-experts-site-vue/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///var/www/html/code-experts-site-vue/node_modules/nitropack/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///var/www/html/code-experts-site-vue/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///var/www/html/code-experts-site-vue/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///var/www/html/code-experts-site-vue/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///var/www/html/code-experts-site-vue/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///var/www/html/code-experts-site-vue/node_modules/source-map/source-map.js';
import { defineDiagnostics, createConsoleReporter } from 'file:///var/www/html/code-experts-site-vue/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file:///var/www/html/code-experts-site-vue/node_modules/nostics/dist/formatters/ansi.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///var/www/html/code-experts-site-vue/node_modules/devalue/index.js';
import { getContext as getContext$1 } from 'file:///var/www/html/code-experts-site-vue/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///var/www/html/code-experts-site-vue/node_modules/errx/dist/index.mjs';
import { isVNode, isRef, toValue } from 'file:///var/www/html/code-experts-site-vue/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///var/www/html/code-experts-site-vue/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///var/www/html/code-experts-site-vue/node_modules/pathe/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///var/www/html/code-experts-site-vue/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///var/www/html/code-experts-site-vue/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///var/www/html/code-experts-site-vue/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///var/www/html/code-experts-site-vue/node_modules/unhead/dist/utils.mjs';
import { DeprecationsPlugin } from 'file:///var/www/html/code-experts-site-vue/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///var/www/html/code-experts-site-vue/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/var/www/html/code-experts-site-vue/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/var/www/html/code-experts-site-vue","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/var/www/html/code-experts-site-vue/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/var/www/html/code-experts-site-vue/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/var/www/html/code-experts-site-vue/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/var/www/html/code-experts-site-vue/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "supabaseUrl": "https://blgbbvrcvjxsizkxqfoe.supabase.co",
    "supabaseKey": "sb_publishable_UKROffDRWLE2lWW_OS4YuQ_lR2jKFnH",
    "recaptchaSiteKey": "",
    "metaPixelId": "",
    "firebaseVapidKey": "",
    "supabase": {
...
const _J831tsRv3lX9qqhSSqFMnOkYy9qmMO8XlsEyWWqDlo = (function(nitro) {
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"theme-color","content":"#ffffff"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"},{"rel":"icon","type":"image/png","sizes":"32x32","href":"/favicon-32x32.png"},{"rel":"icon","type":"image/png","sizes":"16x16","href":"/favicon-16x16.png"},{"rel":"apple-touch-icon","href":"/apple-touch-icon.png"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"pt-BR"}};
...
const rootDir = "/var/www/html/code-experts-site-vue";
...
const plugins = [
  _J831tsRv3lX9qqhSSqFMnOkYy9qmMO8XlsEyWWqDlo,
...
const _5iZpH9 = eventHandler((event) => {
...
const _lazy_RyN0e4 = () => Promise.resolve().then(function () { return contact_post; });
const _lazy_eBuxIs = () => Promise.resolve().then(function () { return newPost_post; });
const _lazy_3R5jx_ = () => Promise.resolve().then(function () { return sitemap_xml; });
const _lazy_jvhkPl = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _5iZpH9, lazy: false, middleware: true, method: undefined },
  { route: '/api/contact', handler: _lazy_RyN0e4, lazy: true, middleware: false, method: "post" },
  { route: '/api/notifications/new-post', handler: _lazy_eBuxIs, lazy: true, middleware: false, method: "post" },
  { route: '/sitemap.xml', handler: _lazy_3R5jx_, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_jvhkPl, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_jvhkPl, lazy: true, middleware: false, method: undefined }
];
...
const contact_post = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null
}, Symbol.toStringTag, { value: 'Module' }));

const newPost_post = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null
}, Symbol.toStringTag, { value: 'Module' }));
